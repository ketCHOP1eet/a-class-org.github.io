...
jQuery(function($) {
	...
	$outerdivs.each(function() {
		...
		$allankers = $(this).find('http://a-klass.z3x.ru/templates/a-klass/javascript/ul.tabs').first().find('a');
...
function tabshow(elid) {
	...
	var $liste = $outerdiv.find('http://a-klass.z3x.ru/templates/a-klass/javascript/ul.tabs').first();
...
var mobileMenu = function(){
	...
	var createElements = function () {
		...
		$menu = $("#header").find('http://a-klass.z3x.ru/templates/a-klass/javascript/ul.menu').first();
